...
export default function BeastItem({beast}) {
    ...
    return (
        ...
        <Card onClick={showFullBeastDetails} className="p-8 0 m-8 bg-white">
            <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
                {/*<p className="text-tiny uppercase font-bold">{beast.name}</p>*/}
                <small className="text-default-500">{beast.type}</small>
                <h4 className="font-bold text-large">{beast.name}</h4>
            </CardHeader>
